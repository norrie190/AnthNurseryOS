...
| Crop geometry    | src/modules/plants/plant-photo-crop.ts                                                                                                                                                                                                 |
| Photo services   | src/modules/plants/plant-photo-input.ts; plant-photo-keys.ts; plant-photo-processing.ts; plant-photo-service.ts; plant-photo-storage.ts; plant-photo-queries.ts                                                                        |
...
| Selector         | src/modules/plants/components/plant-photo-crop-selector.tsx; plant-photo-crop-selector.module.css; plant-photo-crop-selector.test.tsx                                                                                                  |
...
| Tests            | tests/unit/plant-photo-crop.test.ts; plant-photo-processing.test.ts; plant-photo-service.test.ts; plant-photo-storage.test.ts; plant-photo-http.test.ts; tests/database/plant-photo.test.ts; tests/helpers/fake-plant-photo-storage.ts |
