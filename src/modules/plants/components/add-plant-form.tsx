...
export function AddPlantForm({ parents, locations, currencies }: AddPlantFormProps) {
  const [values, setValues] = useState({ ...initialPlantFormValues });
  const [state, formAction, pending] = useActionState(createPlantAction, initialPlantFormState);
    ...
    >
      ...
      <fieldset className={styles.card} disabled={pending}>
        ...
        <p className={styles.hint} id="purchase-help">
          Leave this off if you are not recording a purchase. You can record a purchase even if its
          details are unknown.
        </p>
      ...
      <div className={styles.formFooter}>
        ...
        <div className={styles.actions}>
          ...
          <button className={styles.primaryButton} type="submit" disabled={pending}>
            {pending ? 'Saving Plant…' : 'Save Plant'}
          </button>
        </div>
      </div>
    </form>
