...
import styles from './photo-crop-selector.module.css';
...
export function PhotoCropSelector({
  ...
  disabled = false,
  onReady,
  helpText = 'Choose the area shown in thumbnails and cards. Your full photo stays unchanged. Drag the square or its corners. Use arrow keys to move it, or the size control to resize.',
}: {
  src: string;
